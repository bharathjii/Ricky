...
import static com.userInputDrawing.essentials.DrawEssentials.*;

import java.util.LinkedList;
import java.util.Queue;

import com.userInputDrawing.essentials.DrawEssentials;
...
public class FillInput extends DrawDiagram {
    private Point point;
    private char newChar;

    public FillInput(Canvas canvas, String fullCommand) {
    ...
    public void parseParameters() throws InvalidCommandException {
        ...
        String splitString[] = DrawEssentials.getCommandParams(fullCommand);
